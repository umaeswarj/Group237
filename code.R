...
dataset <- read.csv("C:/Users/Admin/Documents/ZOMARTO_CAFE/reviews.csv")

# Check if the file exists (optional step)
if (!file.exists("C:/Users/Admin/Documents/ZOMARTO_CAFE/reviews.csv")) {
...
setwd("C:/Users/Admin/Documents/ZOMARTO_CAFE")  # Set working directory
